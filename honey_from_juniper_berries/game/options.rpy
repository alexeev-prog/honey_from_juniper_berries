...
define config.name = _("honey_from_juniper_berries")
...
define build.name = "honey_from_juniper_berries"
...
define config.save_directory = "honey_from_juniper_berries-1752409317"
